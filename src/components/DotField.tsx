...
/* Interactive dot grid (React Bits "DotField"), typed for this project.
   A canvas of dots on a diagonal gradient; dots bulge away from the cursor
   and a soft radial glow follows it while the pointer is moving. */
